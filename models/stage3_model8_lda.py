"""
Stage 3 - Model 8: Linear Discriminant Analysis (LDA)
----------------------------------------------------
...
def main():
    ...
    # 5) Build pipeline: Imputer -> Scaler -> LDA
    lda_clf = LinearDiscriminantAnalysis(
        solver="svd",   # default; good for multiclass
    )
    ...
    print("Model details:")
    print("  Model type: LinearDiscriminantAnalysis (sklearn.discriminant_analysis.LinearDiscriminantAnalysis)")
    print("  No learning rate: parameters are obtained by solving an eigenvalue problem / closed-form scatter matrix analysis.")
    print("  Training uses all samples at once (no SGD-style batches).")
