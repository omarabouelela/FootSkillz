"""
Stage 3 - Model 1: Multiclass Logistic Regression
-------------------------------------------------
...
def main():
    ...
    # Drop non-feature columns (IDs / metadata)
    drop_cols = [
        "skill",
        "recording",
        "window_id",
    ...
    # 5) Build pipeline: Imputer -> Scaler -> Logistic Regression
    ...
    # transform once using the pipeline's preprocessing
    # (actually pipeline.predict will do transform+predict;
    # for timing we just call predict in batches)
    batches_idx = [
    ...
    print("Model details:")
    print("  Model type: Multinomial Logistic Regression (sklearn.linear_model.LogisticRegression)")
    print("  Optimizer: lbfgs (line-search, no explicit learning rate hyperparameter).")
    print("  Effective training batch size: full batch (all samples per iteration).")
