"""
Stage 3 - Model 4: K-Nearest Neighbors (KNN)
-------------------------------------------
...
# KNN hyperparameters (you can tweak later)
N_NEIGHBORS = 5
...
def main():
    ...
    # 5) Build pipeline: Imputer -> Scaler -> KNN
    # Scaling is important for KNN because it uses distances.
    ...
    print("Model details:")
    print("  Model type: KNeighborsClassifier (sklearn.neighbors.KNeighborsClassifier)")
    print("  No learning rate: KNN is a lazy learner (stores data, no gradient descent).")
    print("  Training 'batch size': model 'training' is essentially storing all training samples.")
