"""
Stage 3 - Model 5: Gaussian Naive Bayes
--------------------------------------
- Loads features_balanced_windows.csv
- Encodes labels
- Train/test split (stratified)
- Pipeline: SimpleImputer -> StandardScaler -> GaussianNB
...
def main():
    ...
    # 5) Build pipeline: Imputer -> Scaler -> GaussianNB
    nb_clf = GaussianNB()
    ...
    print("Model details:")
    print("  Model type: GaussianNB (sklearn.naive_bayes.GaussianNB)")
    print("  No learning rate: parameters are estimated analytically (means/variances per class).")
    print("  Training 'batch size': uses all training samples to estimate class-conditional Gaussians.")
